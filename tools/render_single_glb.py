...
parser.add_argument(
    "--engine", type=str, default="BLENDER_EEVEE_NEXT", choices=["CYCLES", "BLENDER_EEVEE_NEXT"]
)
parser.add_argument("--num_images", type=int, default=12)
parser.add_argument("--camera_dist", type=float, default=1.2)
# 新增分辨率参数
parser.add_argument("--resolution_x", type=int, default=224)
parser.add_argument("--resolution_y", type=int, default=224)
...
render.resolution_x = args.resolution_x  # 从参数读取
render.resolution_y = args.resolution_y  # 从参数读取
...
def save_images(object_file: str) -> None:
   ...
   # ===== 保存相机参数（推荐方式）=====
    ...
    for frame in range(bproc.utility.num_frames()):
        cam2worlds.append(bproc.camera.get_camera_pose(frame))
